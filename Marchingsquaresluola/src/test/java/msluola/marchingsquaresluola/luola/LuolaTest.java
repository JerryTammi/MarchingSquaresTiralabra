...
public class LuolaTest {
    ...
    @Test
    public void testiLisaaViivatOnkoViivoja() {
        luola.luoTaulukko(pisteet);
        luola.lisaaViivat(pisteet, ikkuna, vali);
        boolean loytyykoViiva = true;
        if (ikkuna.getChildren().isEmpty()) loytyykoViiva = false;
        assertEquals(true, loytyykoViiva);
    }
    
    @Test
    public void testiLisaaSeinaVariOnkoVaritetty() {
        luola.luoTaulukko(pisteet);
        luola.lisaaViivat(pisteet, ikkuna, vali);
        int koko = ikkuna.getChildren().size();
        luola.lisaaSeinaVari(pisteet, ikkuna, vali);
        boolean onko = true;
        if (koko == ikkuna.getChildren().size()) onko = false;
    ...
    @Test
    public void testiMaaritaNaytetaankoPisteetTrue() {
        luola.luoTaulukko(pisteet);
        luola.maaritaNaytetaankoPisteet(true);
        assertEquals(true, luola.haePisteetMaaritys());
    }
    
    @Test
    public void testiMaaritaNaytetaankoPisteetFalse() {
        luola.luoTaulukko(pisteet);
        luola.maaritaNaytetaankoPisteet(false);
        assertEquals(false, luola.haePisteetMaaritys());
    }
}
